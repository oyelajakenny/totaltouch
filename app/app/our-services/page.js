...
export default function Page() {
  return (
    <main className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      {/* CTA Banner */}
      <section className="mt-16 overflow-hidden rounded-3xl border border-slate-200 bg-gradient-to-br from-slate-50 to-white p-6 sm:p-10">
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-5">
            <dl className="grid grid-cols-2 gap-4 text-sm text-slate-700 sm:grid-cols-3">
              ...
              <div>
                ...
                <dd className="mt-1 text-slate-600">Citywide</dd>
              </div>
            </dl>
          </div>
        </div>
