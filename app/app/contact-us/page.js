...
const page = () => {
  return (
    <div className="conatiner mx-auto flex flex-col justify-start items-center">
      ...
      <div className="container  w-full flex flex-col-reverse md:flex-col-reverse lg:flex-row items-center justify-between px-4 lg:px-40 ">
        <div className="w-full  lg:w-1/2 m-7 grid grid-cols-2 gap-3 ">
          {contact.map((items, index) => {
            return (
              <div
                key={index}
                className="flex justify-start items-start shadow-sm rounded-sm gap-2 p-2 lg:p-5 bg-white mb-5"
              >
        ...
        <div className="bg-white p-10 rounded-md shadow-md m-5 w-full lg:w-1/2">
          <form className="flex flex-col gap-5">
            ...
            <button
              type="submit"
              className=" w-full bg-blue-500 text-white p-3 rounded-md  mx-auto"
            >
              Submit
            </button>
          </form>
